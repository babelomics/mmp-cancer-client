...
function AssociatedTableHeader(props: IProps) {
  ...
  return (
    <TableHead>
      <TableRow>
        ...
        <ColumnHeader label={t('commons.fields.groups')} sortId="groups" filter={filter} setFilter={setFilter} />
        <TableCell />
      </TableRow>
    </TableHead>
  );
...
export default AssociatedTableHeader;
